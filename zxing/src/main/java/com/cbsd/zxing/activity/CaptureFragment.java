package com.cbsd.zxing.activity;
...
import com.cbsd.zxing.decoding.CaptureActivityHandler;
import com.cbsd.zxing.decoding.InactivityTimer;
import com.cbsd.zxing.view.ViewfinderView;
        ...
        disposable = Observable.timer(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Consumer<Long>() {
                    ...
                    public void accept(Throwable throwable) throws Throwable {
                        Log.d("CaptureFragment", "扫描异常：" + throwable.getMessage());
                    }
                });
    }
